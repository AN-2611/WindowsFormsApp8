...
namespace WindowsFormsApp8
{
    public partial class Form1 : Form
    {
        ...
        private void indam_Click_1(object sender, EventArgs e)
        {
            if (richText.SelectionFont != null)
            {
                Font currentFont = richText.SelectionFont;
        ...
        private void innghien__Click(object sender, EventArgs e)
        {
            if (richText.SelectionFont != null)
            {
                Font currentFont = richText.SelectionFont;
        ...
        private void gachchan__Click_1(object sender, EventArgs e)
        {
            if (richText.SelectionFont != null)
            {
                Font currentFont = richText.SelectionFont;
